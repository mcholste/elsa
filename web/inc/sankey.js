  ...
  function computeNodeLinks() {
    ...
    links.forEach(function(link) {
      var source = link.source,
          target = link.target;
      // console.log('link.source', link.source, 'nodes[link.source]', nodes[link.source]);
      // console.log('link.target', link.target, 'nodes[link.target]', nodes[link.target]);
      if (typeof source === "number") source = link.source = nodes[link.source];
      if (typeof target === "number") target = link.target = nodes[link.target];
      // console.log('source', source, 'target', target);
      // if (typeof(source.sourcelinks) === 'undefined') source.sourceLinks = [];
      // if (typeof(target.targetLinks) === 'undefined') target.targetLinks = [];
